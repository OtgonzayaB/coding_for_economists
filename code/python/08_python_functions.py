...
# Keyword arguments: using argument name to assign a value, here, order does not matter
print(exponentiate(exponent=3, num=2))
...
def cast_listitems_to_str(list_of_objects):
  """
  Casts all items in a list to list of strings.
...
print(cast_listitems_to_str([1, 3, 4]))
...
c = 5 # Here, 'c' is a global variable
